...
import { getVideoTaskById } from 'apiSdk/video-tasks';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Video Task Detail View
          </Text>
          {hasAccess('video_task', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/video-tasks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
