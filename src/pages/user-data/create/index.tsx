...
import { createUserData } from 'apiSdk/user-data';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="articulation" mb="4" isInvalid={!!formik.errors?.articulation}>
            ...
            <Input type="text" name="articulation" value={formik.values?.articulation} onChange={formik.handleChange} />
